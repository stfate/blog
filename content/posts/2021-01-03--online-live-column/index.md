...
- 2020年の暮れに，改めて「オンラインライヴ」の価値、在り方を考えたい
- そもそも「コンサート/ライヴ」の価値とはなにか？
    - 音楽の演奏を聴かせる(コンテンツそのもの)
    - 同じ"場"を共有する (場：時間・空間・コンテンツ)
    - 演者と観客のインタラクション
- オンラインライヴの目的
    1. 現地ライヴの代替(とにかく公演を開催できる手段を確保する)
    2. オンラインだからこそ実現できる「表現」「ショウ」を見せる
- 僕は2.を目指していく方が長期的にはプラスになると思っているし、2.まで到達しているライヴが観たい
- オンラインライヴで実現できること・できないこと
    - できること・向いていること
        - 演奏を高品質で配信する
            - 演奏を"聴く"ことにおいては現地ライヴよりもアドバンテージがある
        - マルチアングルでの映像を見せられる
            - 演者のアップ、楽器の手元を映す、などが「全ての観客」に提供できる
        - バックステージやメイキングなどを公演中に挟める：現地でもバックスクリーンに映すことは不可能ではないが，配信ではより効果的に見せられる
        - 気軽に参加できる
            - 「ちょっと観てみるか～～～」と軽率に観れる
    - できないこと・苦手なこと
        - 演者と観客のインタラクション
            - VR/MR/ARデバイスが進化すればこれは越えられるかもしれない．
            - 声出しができない現在の状況では、現地ライヴでも満足なインタラクション取れないかも
        - 同じ空間を共有する
            - 現地の一番の強みかもしれない
        - 生の音を体感する
            - 空気を振動して直に伝わる音と、スピーカー/ヘッドフォンから聴く音には大きな違いがある
- オンラインライヴに向いているコンテンツ・向いていないコンテンツ
    - 向いている："曲を聴く"が主眼になるコンテンツ (アコースティック，クラシック，ジャズなど)
    - 向いていない：演者と観客のインタラクション&空間の共有が主眼になるコンテンツ (アイドル，ロックバンドなど)
- オンラインライヴにおけるコンテンツの見せ方
    - テンションが下がる要因
        - "お客さんがいない"不完全な場であることが映像からわかってしまう (空席の観客席を映してしまう、など)
    - 現地ライヴとはそもそも違う見せ方にして、「欠けているもののない場」を構築することが必要では
        - スタジオからセッション的な見せ方をするか、円形ステージで円陣スタイルあたりが好き
        - 「インタラクティブ性のある音楽番組」アプローチ
            - メイキングやバックステージ，インタビューを挿入する
            - SNSやチャットを活用したインタラクション (リアルタイム投票でセトリ決める，とか)
- オンラインライヴにおける"没入感"
    - 現地ライヴは"非日常"，オンラインライヴは"日常"に溶け込んでしまう
    - 現地ライヴは自然とテンション上がるし没入感も非常に高い
    - 対して，オンラインライヴは集中を阻害する要因がたくさんある
        - ながら見ができてしまう
        - 他のもの(Twitterとか家のインテリアとか)が目に入って集中力が阻害される
        - ライヴに入り込めるかが視聴環境に大きく依存する (画面サイズ，音質)
        - 通信障害，音飛び (個人的に一番の敵)
    - 没入感を高めるにはどうすればよいか？
        - ライヴ画面以外見えない環境を作る
            - 部屋の電気消すなど
        - 大きいTV、音質の良いヘッドフォンやスピーカーを買う
            - オンラインライヴに最適化されたHMDとかあれば欲しい
        - 非日常感を出すために、特別なことをしてみる
            - 贅沢な夕飯にする，お高いお酒を飲む，ライヴT着る，など
        - 現状では観客側が努力するしかないが、技術で解決したいところ
- まとめ
    - 僕は「現地ライヴとは違うもうひとつのライヴ鑑賞形態、もう一つの武器」として確立して欲しいと思っている
    - オンラインライヴが向いているコンテンツについてはどんどん活用してほしい
    - もちろん現地でしか達成できない価値もあるので、両者併用しながらこの難局を乗り切って欲しい
- 良かったオンラインライヴ
    - fhána
